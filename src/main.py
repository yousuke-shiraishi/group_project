...
if __name__ == '__main__':
    ...
    while True:
        ...
        while cart_loop == True:
            ...
            while True:
                ...
                if ret:
                    ...
                    if detected_image is not None:
                        ...
                        if th < 0.8:
                            ...
                            #sound
                            pygame.mixer.music.load("../ui/sound/zannen.mp3") #読み込み
                        ...
                        #しきい値以下(該当する商品)
                            ...
                            #sound
                            pygame.mixer.music.load("../ui/sound/scan.mp3") #読み込み
                            pygame.mixer.music.play(1) #再生
                            sleep(1.5)
                            pygame.mixer.music.stop() #終了
                ...
                if key == ord('q'):
                    ...
                    #sound
                    pygame.mixer.music.load("../ui/sound/okini.mp3") #読み込み
                    pygame.mixer.music.play(1) #再生
                    sleep(1.5)
                    pygame.mixer.music.stop() #終了
                ...
                #'r'が押されると一つ前の商品を抜く
                    ...
                    #sound
                    pygame.mixer.music.load("../ui/sound/ee.mp3") #読み込み
                    pygame.mixer.music.play(1) #再生
                    sleep(1.5)
                    pygame.mixer.music.stop() #終了
                ...
                #'a'が押されると初期画面へ
                    ...
                    #sound
                    pygame.mixer.music.load("../ui/sound/syuuryou.mp3") #読み込み
                    pygame.mixer.music.play(1) #再生
                    sleep(1.5)
                    pygame.mixer.music.stop() #終了
        ...
        #'s'が押されると検出開始
            ...
            #sound
            pygame.mixer.music.load("../ui/sound/irassyai.mp3") #読み込み
            pygame.mixer.music.play(1) #再生
            sleep(2)
            pygame.mixer.music.stop() #終了
